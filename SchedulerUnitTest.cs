...
namespace UnitTesting
{
    ...
    public class SchedulerUnitTest
    {
        ...
        public void TestShortestJobFirst()
        {
            ...
            Assert.IsTrue(UnitTesting.JobArrayEqual(expected, actual, Parameter.ExecutionTime), "ShortestJobFirst failed to sort Jobs by executionTime.");
        }
        ...
        public void TestPriority()
        {
            ...
            Assert.IsTrue(UnitTesting.JobArrayEqual(expected, actual, Parameter.Priority), "Priority failed to sort Jobs by priority.");
        }
        ...
        public void TestFirstComeFirstServed()
        {
            ...
            Assert.IsTrue(UnitTesting.JobArrayEqual(expected, actual, Parameter.TimeReceived), "FirstComeFirstServed failed to sort Jobs by timeReceived.");
        }
    }
}
